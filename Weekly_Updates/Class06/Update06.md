...
This week, For the One-Class SVM, I tested different kernels (like RBF and linear) and tuned hyperparameters such as nu to effectively define the boundary around normal network traffic.
